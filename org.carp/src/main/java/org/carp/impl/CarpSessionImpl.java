...
public class CarpSessionImpl implements CarpSession{
	...
	private boolean enableScrollResultSet = false;
	private boolean autoGeneratedKeys; //当 primarykey auto increase
	/**
	 * 
	 * @param provider
...
//			return null;
	...
	@Override
	public void setEnableScrollResultSet(boolean bool) {
		this.enableScrollResultSet = bool;
	}

	public boolean enableScrollResultSet(){
		return this.enableScrollResultSet;
	}
